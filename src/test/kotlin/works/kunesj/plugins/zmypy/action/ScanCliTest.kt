...
class ScanCliTest : AbstractToolWindowTestCase() {
    ...
    private fun isIncompleteConfigNotification(notification: com.intellij.notification.Notification): Boolean {
        return ZMypyBundle.message("notification.group.mypy.group") == notification.groupId &&
                ZMypyBundle.message(
                    "mypy.notification.incomplete_configuration",
                    MypySettings.getInstance(project).tool.displayName
