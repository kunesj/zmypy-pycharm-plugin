...
class MypyIgnoreIntention(private val issue: MypyMessage) : PsiElementBaseIntentionAction(), IntentionAction {
    ...
    override fun getText(): String = ZMypyBundle.message("mypy.intention.ignore.text", issue.code)

    override fun getFamilyName(): String = ZMypyBundle.message("mypy.intention.ignore.family_name")
